    ...
    <div class="flex justify-content-center p-2">
        <div class="surface-card p-4 shadow-2 border-round w-full lg:w-6">
            <div class="text-center mb-3">
                ...
                <a
                    class="font-medium no-underline ml-2 text-blue-500 cursor-pointer select-none"
                    @click="toggleAuth"
                >
                    {{ linkAccountText }}
                </a>
            ...
            <form @submit.prevent="submitForm">
                <app-ifta-label class="mb-3">
                    <label for="email1" class="block text-900 font-medium">Email</label>
                    <app-input-text v-model="email" id="email1" type="email" class="w-full" />
                </app-ifta-label>

                <app-ifta-label class="mb-3">
                    <label for="password1" class="block text-900 font-medium">Пароль</label>
                    <app-input-text
                        v-model="password"
                        id="password1"
                        type="password"
